...
- (void)layoutSubviews {
    ...
    self.placeholderLabel.height= [CZJUtils calculateStringSizeWithString:_myPlaceholder Font:self.font Width:maxSize.width].height;
}
